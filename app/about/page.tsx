...
const teamMembers = [
  ...
  {
    name: "אייל שמריהו",
    role: "עורך דין, מגשר משפחתי ומומחה ליישוב סכסוכים במשפחה",
    image: "/eyal.png",
    points: [
      'בעל ניסיון וותק של למעלה מ-18 שנה כעו"ד בתחום דיני המשפחה, הן בייצוג וניהול תיקים מורכבים בערכאות השיפוט, והן במסגרת הליכי גישור ומו"מ.',
      'בעל ניסיון רב שנים בגישור ויישוב סכסוכים, הן במגזר הציבורי כעו"ד לשעבר של יחידות הסיוע שליד בתי המשפט לענייני משפחה, והן במגזר הפרטי.',
    ],
  },
];
