            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-5xl font-bold text-white mb-4">
                  {c["lawyers.header.title"]}
                </h1>
                <p className="text-white/55 text-xl">
                  {c["lawyers.header.subtitle"]}
                </p>
              </div>
        ...
        <FadeIn>
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl font-bold text-navy mb-4">
              {c["lawyers.benefits.title"]}
            </h2>
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">
              {c["lawyers.benefits.subtitle"]}
            </p>
          </div>
        </FadeIn>
            ...
            <FadeIn key={i} delay={i * 100}>
              <div className="border border-gray-100 rounded-xl p-8 text-center hover:border-gold hover:shadow-md transition-all duration-300 border-t-4 border-t-gold h-full">
                ...
                <h3 className="font-bold text-navy text-xl mb-3">
                  {c[`lawyers.benefits.${i}.title`]}
                </h3>
                <p className="text-gray-500 text-sm leading-relaxed">
                  {c[`lawyers.benefits.${i}.desc`]}
                </p>
              </div>
            </FadeIn>
          ))}
          ...
          <FadeIn>
            <div className="text-center mb-10">
              ...
              <h2 className="text-3xl font-bold text-navy mb-3">
                {c["lawyers.form.title"]}
              </h2>
              <p className="text-gray-500">
                {c["lawyers.form.subtitle"]}
              </p>
            </div>
          </FadeIn>
          <LawyerContactForm />
