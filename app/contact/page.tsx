        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <FadeIn>
            ...
            <h1 className="text-5xl font-bold text-white mb-4">
              {c["contact.header.title"]}
            </h1>
            <p className="text-white/55 text-xl">
              {c["contact.header.subtitle"]}
            </p>
          </FadeIn>
        </div>
      </section>
            ...
            <FadeIn delay={120}>
                  ...
                  <li key={i} className="flex items-start gap-4">
                    ...
                    <div>
                      <div className="text-xs text-gold font-semibold uppercase tracking-wider mb-1">
                        {c[`contact.info.${i}.label`]}
                      </div>
                      <div className="text-gray-700">
                        {c[`contact.info.${i}.value`]}
                      </div>
                    </div>
                  </li>
                ))}
              ...
              <div className="border border-gray-100 rounded-xl p-6 bg-gray-50">
                <h3 className="font-bold text-navy mb-4">
                  {c["contact.hours.title"]}
                </h3>
                <ul className="space-y-2 text-sm text-gray-600">
                  {[0, 1, 2].map((i) => (
                    <li key={i} className="flex justify-between">
                      <span>{c[`contact.hours.${i}.day`]}</span>
                      <span className="font-medium text-navy">
                        {c[`contact.hours.${i}.time`]}
                      </span>
                    </li>
                  ))}
                </ul>
